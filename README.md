...
![4](/Users/jajamoa/Microsoft_Speech_API/img/3.gif)

在后端返回生成结果后，在下方，我们可以看到SDA对 **通过TTS生成的标准语音** 生成的口型视频，点击对应的 **播放视频** 按钮即可播放视频进行对比学习。

![4](/Users/jajamoa/Microsoft_Speech_API/img/4.gif)
